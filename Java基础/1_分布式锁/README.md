 ...
 * 这就是模板设计模式
 */
public abstract class AbstractTemplateLock implements DistributedLock{
...
同时我们在抽象类里，又定义了两个抽象方法，waitLock()  和 tryLock
 ...
 *
 */
public class ZkDistributedLock extends AbstractTemplateLock{
    @Override
...
public class OrderService {
    ...
    public void getOrderNumber() {
        Lock zkLock = new ZkDistributedLock();
        zkLock.lock();
        try {
